// count = 0;
// function add_options_btn(){
//     count++;
//     const crtelmnt = document.createElement('input');
//     crtelmnt.setAttribute('type','text');
//     crtelmnt.setAttribute('name','option_'+count);
//     crtelmnt.setAttribute('placeholder','option_'+count);
//     document.getElementById('modeltestform').appendChild(crtelmnt);
// }
