...
/////////////////////////// ROUTINE STATUS BUTTON CODE IS START ///////////////////////////////////////////
let inPt = document.getElementById("examStatusValue").value;
if(!inPt){
...
function routineStatusFun(x){
    if(Number.isInteger(counter/2)){
        ...
        // BACKGROUNG COLOR
        document.getElementById("routineStatus").style.background = "green";
    }
    else{
        document.getElementById("routineStatus").setAttribute("value","Off");
        document.getElementById("examStatusValue").setAttribute("value","Off");
        // BACKGROUNG COLOR
        document.getElementById("routineStatus").style.background = "#f5493d";
    }
    counter++;
    document.getElementById("routineStatus").style.color = "white";
}
/////////////////////////// ROUTINE STATUS BUTTON CODE IS END ///////////////////////////////////////////